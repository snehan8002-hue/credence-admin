(function(){
'use strict';
const STYLE='credence-reference-mobile-v5-style';
function txt(x){return(x?.textContent||'').replace(/\s+/g,' ').trim()}
...
body{background:#f3f7f4!important;padding:0!important}
...
#dashboard{width:100%!important;max-width:100%!important;box-sizing:border-box!important;padding:0 14px 130px!important;overflow:visible!important}
#dashboard .top{position:relative!important;width:calc(100% + 28px)!important;height:82px!important;min-height:82px!important;margin:0 -14px 16px!important;padding:0!important;background:linear-gradient(135deg,#005d35,#078b4c)!important;border:0!important;border-radius:0 0 18px 18px!important;overflow:hidden!important;box-shadow:0 6px 16px rgba(0,85,45,.16)!important}
...
.ceFinalLogo{width:40px!important;height:40px!important;border-radius:10px!important;background:#0b9b55!important;display:grid!important;place-items:center!important;font-size:22px!important;flex:0 0 40px!important}
...
#dashboard .card{min-width:0!important;width:100%!important;border-radius:18px!important;padding:14px!important;border:1px solid #e1eae4!important;background:#fff!important;box-shadow:0 6px 18px rgba(10,70,40,.07)!important}
...
#dashboard .grid2{min-width:0!important;width:100%!important}
.mobilebar{position:fixed!important;left:8px!important;right:8px!important;bottom:max(8px,env(safe-area-inset-bottom))!important;width:auto!important;height:76px!important;min-height:76px!important;max-height:76px!important;box-sizing:border-box!important;display:grid!important;grid-template-columns:repeat(9,minmax(0,1fr))!important;grid-auto-flow:column!important;align-items:stretch!important;gap:0!important;padding:4px!important;margin:0!important;background:rgba(255,255,255,.99)!important;border:3px solid #18b85b!important;border-radius:20px!important;box-shadow:0 8px 25px rgba(10,70,40,.18)!important;z-index:2147483000!important;overflow:hidden!important;overscroll-behavior:none!important;touch-action:manipulation!important}
...
patch();let n=0;const timer=setInterval(()=>{patch();if(++n>100)clearInterval(timer)},250);new MutationObserver(()=>patch()).observe(document.body,{childList:true,subtree:true});
})();